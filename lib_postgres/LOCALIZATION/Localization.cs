...
namespace lib_postgres.LOCALIZATION
{
    public class Localization
    {
        ...
        public static Dictionary<string, string> LangID_to_res_files = new Dictionary<string, string>()
            {
                { "EN", "lib_postgres.LOCALIZATION.EN" },
                { "FR", "lib_postgres.LOCALIZATION.FR" },
                { "RU", "lib_postgres.LOCALIZATION.RU" }
            };
        ...
        public static string Substitute(string key)
        {
            ...
            ResourceManager RM = new ResourceManager(resname, Assembly.GetExecutingAssembly());
        ...
        private static void Show_Actual_Language_in_Top(ToolStripMenuItem ToolStripMenuItem_UI_Language)
        {
            ...
            ToolStripMenuItem_UI_Language.Text = Get_Short_Language_Name_by_Culture(current_Culture);
        }
        ...
        {
            string short_lang = Get_Short_Language_Name_by_Culture(Thread.CurrentThread.CurrentUICulture);
