...
INSERT INTO public.genre (id, name, _is_deleted) VALUES (69, 'Познание', NULL);
...
INSERT INTO public.genre (id, name, _is_deleted) VALUES (68, 'Языческая литература и атеизм', NULL);
...
SELECT pg_catalog.setval('public.genre_id_seq', 119, true);
