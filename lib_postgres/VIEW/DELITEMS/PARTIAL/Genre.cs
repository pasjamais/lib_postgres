...
namespace lib_postgres
{
    ...
    {
        public static List<Genre> Get_Deleted_Items()
        {
            List<Genre> items = DB_Agent.Get_Genres();
            List<Genre> deleted_items = (from item in items
        ...
        {
            List<Genre> deleted_items = Get_Deleted_Items();
