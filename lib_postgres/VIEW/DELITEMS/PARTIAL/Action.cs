...
namespace lib_postgres
{
    public partial class Action : IHas_field_IsDeleted
    {
        ...
        public static List<Action> Get_Deleted_Items()
        {
            List<Action> items = DB_Agent.Get_Actions();
            List<Action> deleted_items = (from item in items
        ...
        {
            List<Action> deleted_items = Get_Deleted_Items();
