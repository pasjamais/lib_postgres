namespace lib_postgres
{
    public partial class City : IContextMenuPreparation
    {
        public static ToolStripItem[] ContexctMenu_Prepare()
        {
            ...
            items.Add(Context_Menu_Items_Builder.Create_Menu_Item_Using_Form_Resource("ToolStripMenuItem_City_Edit.Text", "ToolStripMenuItem_City_Edit_Click"));
            items.Add(Context_Menu_Items_Builder.Create_Menu_Item_Using_Form_Resource("ToolStripMenuItem_City_Delete.Text", "ToolStripMenuItem_City_Delete_Click"));
