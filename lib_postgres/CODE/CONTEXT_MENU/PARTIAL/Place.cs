namespace lib_postgres
{
    public partial class Place : IContextMenuPreparation
    {
        public static ToolStripItem[] ContexctMenu_Prepare()
        {
            ...
            items.Add(Context_Menu_Items_Builder.Create_Menu_Item_Using_Form_Resource("ToolStripMenuItem_Places_Edit.Text", "ToolStripMenuItem_Places_Edit_Click"));
            items.Add(Context_Menu_Items_Builder.Create_Menu_Item_Using_Form_Resource("ToolStripMenuItem_Places_Delele.Text", "ToolStripMenuItem_Places_Delele_Click"));
